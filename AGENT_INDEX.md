...
| Build a QMI8658 tilt/flick-controlled LVGL game for the K10 experiment box | `unihiker-k10-box-platformio` | Read `references/six-axis-games.md`; calibrate neutral input and distinguish box QMI8658 from native SC7A20H. |
| Build a K10 microphone FFT waveform/spectrum with sound-reactive box lights | `unihiker-k10-box-platformio` | Read `references/audio-fft.md`; microphone PCM is K10-native I2S while traffic lights belong to box IO `0x20`. |
